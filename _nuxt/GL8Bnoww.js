import{k as o,s as a}from"./DZZjY83M.js";const r=[...o,...a],n=Object.fromEntries(r.map(e=>[e.id,e])),t=e=>{const s=n[e];if(!s)throw new Error(`Speaker not found: ${e}`);return s},i=[{id:"nurse",type:"keynote",title:"Keynote",speaker:t("nurse"),abstract:"詳細は後日公開します。"},{id:"harukasan",type:"session",title:"「照らす技術」をRubyで照らす",speaker:t("harukasan"),abstract:`ステージを華やかに彩る照明や、演者の影でせわしなく動き回るムービングライト。これらを裏側で制御する共通言語が「DMX512」という通信プロトコルです。本セッションでは、ふだん裏方に徹している「ステージを照らす技術」にスポットライトを当て、そのプロトコルの実装を紹介します。
