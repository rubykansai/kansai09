...
セッションの最後には、実際に会場へ持ち込んだムービングライトを、Rubyコードを用いてリアルタイムに制御するデモンストレーションを実施する予定です。Rubyが多様なプロトコルを話すことで広がる、新たな表現の可能性をぜひ体感してください。`,
  },
  {
    id: 'aim2bpg',
    type: 'session',
    title: 'Project Naraku 外伝 —— レールロード図で照らすOnigmoのバグ',
    speaker: speaker('aim2bpg'),
    abstract: `「spoiler: Naraku was Onigumo.」——README の冒頭にそう記されています。Oniguruma（鬼車）・Onigmo（鬼雲）を受け継いだ Ruby 専用の正規表現エンジン、それが Naraku（奈落）。その存在を知ったのは RubyKaigi 2026、makenowjust さんの発表でした。
...
手探りの試みを重ねてきた過程を、Project Naraku の外伝としてお届けします。`,
  },
  {
    id: 'se4weed',
    type: 'session',
