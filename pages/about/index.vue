    ...
    <v-row>
      <v-col align="center" class="pb-0 mt-12">
        <v-card
          max-width="90vw"
          min-width="90vw"
          class="py-10 my-15 px-15 d-none d-md-block"
          :elevation="0"
        >
          <v-card-item>
            <div align="left">
              ...
              <p align="center" class="text-body-1 mb-10 mx-10">
                ...
                関西圏を中心にRubyistが集まり、Rubyに関する技術講演を聞いたり、Rubyist同士が知見を共有したりする場として開催しています。<br>
                また、知的好奇心を刺激し、新たなつながりを生む場となることを目指しています。<br>
                みなさまのご参加をお待ちしています！
              </p>
              <a href="mailto:kansai09@rubykaigi.org">
  ...
  data: () => ({
    organizers: [
      ...
      },
      {
        ...
        role: 'Organizer',
        image: 'https://avatars.githubusercontent.com/u/471923',
      },
      {
        name: 'luccafort',
        twitter: 'https://twitter.com/luccafort',
        github: 'https://github.com/luccafort',
        role: 'Organizer',
      ...
      {
        name: 'youcune',
        twitter: 'https://twitter.com/youcune',
      ...
      {
        name: 'znz',
        twitter: 'https://twitter.com/znz',
        github: 'https://github.com/znz',
        role: 'Organizer',
      ...
      {
        name: 'k-yoshida',
        twitter: 'https://twitter.com/8maim0',
        github: 'https://github.com/k-yoshida',
        role: 'Organizer',
        image: 'https://avatars.githubusercontent.com/u/17219700',
      },
      {
        name: '無双',
        twitter: 'https://twitter.com/nishi_okashi',
        github: 'https://github.com/nishioka-shinji',
        role: 'Organizer',
        image: 'https://avatars.githubusercontent.com/u/46985135',
      },
      {
        name: '107steps',
        twitter: 'https://twitter.com/107steps',
      ...
      {
        name: 'kosaki',
        github: 'https://github.com/kosaki',
        role: 'Organizer',
        image: 'https://avatars.githubusercontent.com/u/82712',
      },
    ],
    designers: [
      {
    ...
    communities: [
      { name: 'AKASHI.rb', link: 'https://akashi-rb.connpass.com/', image: '/communities/akashi.png' },
      { name: 'Hirakata.rb', link: 'https://hirakatarb.connpass.com/', image: '/communities/default.png' },
      { name: 'KOBE.rb', link: 'https://koberb.doorkeeper.jp/', image: '/communities/kobe.png' },
      { name: 'Kyobashi.rb', link: 'https://kyobashirb.connpass.com/', image: '/communities/kyobashi.png' },
      { name: 'Kyoto.rb', link: 'https://kyotorb.connpass.com/', image: '/communities/kyoto.png' },
      { name: 'naniwa.rb', link: 'https://naniwarb.doorkeeper.jp/', image: '/communities/naniwa.png' },
      { name: 'Ruby関西', link: 'https://rubykansai.doorkeeper.jp/', image: '/communities/rubykansai.png' },
      { name: 'Ruby舞鶴', link: 'https://ruby-maizuru.connpass.com/', image: '/communities/rubymaizuru.png' },
      { name: 'Ruby Tuesday', link: 'https://ruby-tuesday.doorkeeper.jp/', image: '/communities/rubytuesday.png' },
      { name: 'Shinosaka.rb', link: 'https://shinosakarb.doorkeeper.jp/', image: '/communities/shinosaka.png' },
      { name: 'Wakayama.rb', link: 'https://wakayama-rb.connpass.com/', image: '/communities/wakayama.png' },
    ],
    supporter: {
      name: '日本Rubyの会',
      link: 'https://ruby-no-kai.org/',
      image: '/communities/rubynokai.png',
    },
  }),
}
</script>
