    ...
    <v-container fluid class="main-content">
      <v-row>
        <v-col align="center" class="pb-0 mt-12">
          ...
          >
          <v-card-item>
            <h1 class="text-h4 title align-center justify-center mb-15">
  ...
  data: () => ({
    biwa: [
      {
        ...
        description: '虎の穴ラボは、同人誌通販サイト「とらのあな通信販売」をはじめ、クリエイター支援プラットフォーム「Fantia（ファンティア）」「Creatia(クリエイティア)」など、オタクカルチャーを支えるWebサービスの開発・運営を行う企業です。「クリエイターのファミリーになる」という理念のもと、すべてのクリエイターの創作活動を支援し、ファンとの新しい繋がりの場を提供しています。その中でFantiaは、登録ユーザー数2,000万人を超える大規模なサービスへと成長しました。私たちは、この急成長するサービスの膨大なトラフィックとデータ処理を、Ruby on Railsを中心とした技術スタックで支えています。今後も、大規模サービスならではの技術的課題に挑戦し、次世代のクリエイターエコノミーを技術の力で牽引していきます。世界中のクリエイターとファンを繋ぐプラットフォームを、共に作り上げる仲間を募集しています。',
    ...
    gold: [
      ...
      },
      {
        name: '株式会社IVRy',
        url: 'https://ivry.jp/',
        description: '株式会社IVRyは「最高の技術を、すべての人と企業に届ける」をミッションに掲げ、対話型音声AI SaaS「アイブリー」を開発・提供しています。24時間365日稼働するAIが、電話応対を自動化・標準化し、業務効率と顧客体験の質を同時に向上させます。あらゆるコミュニケーションデータをAIで解析・活用し、企業の成長を支援します。',
